...
class Simulator:
    ...
    # NOTE: get_paper2_results() was REMOVED per UPDATE_BRIEF_FOR_CODE_CHAT.md §5.1.
    # That function returned hardcoded fabricated numbers (FND 379 / PDR 0.918 / etc.)
    # which conflicted with the verified 30-run figures from the frozen Paper 2.
    # The dashboard now reads only wsn_results.json / wsn_results_paper2.json,
    # both of which contain verified §4 values.
